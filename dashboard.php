...
$query = "SELECT ug.group_name, ug.group_description, gm.group_id 
       ...
       <ul class="list-group">
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <li class="list-group-item">
                    You have been added to <strong><?php echo htmlspecialchars($row['group_name']); ?></strong>
                    <br>
                    <small><?php echo htmlspecialchars($row['group_description']); ?></small>
                </li>
            <?php } ?>
        </ul>
    </div>	
