...
<span style="float:right;"><a href="change-password.php">Change Password</a> | <a href="logout.php">Logout</a></span>
					</div>
...
?>
							<form role="form" method="post" action="">
								<div class="form-group">
									...
									<img src="<?php  echo $row['profile_photo'];?>" height="200" width="200"> 
								</div>
								<div class="form-group">
...
<input type="email" class="form-control" name="email" value="<?php  echo $row['profession'];?>" required="true" readonly="true">
								</div>
								
								<div class="form-group">
									<label>Age</label>
<input type="email" class="form-control" name="email" value="<?php  echo $row['age'];?>" required="true" readonly="true">
								</div>
